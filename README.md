...
#### 🧪 اختبارات
- **110 اختبار** يغطون: الأدوات، الأمان، الهوكات، التعريب، النسخ الاحتياطي، منطق الأقساط، مسار المستحقات الكامل على IndexedDB، التحويل بين المجموعات، التسعير بالحصص، وتنبيهات المديونيات
